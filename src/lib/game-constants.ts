...
export const MINION_MASTER_LIST: MinionData[] = [
  ...
  { type: "Shulker-Box", cost: 4, movementPattern: "Attack-move only", attackPattern: "T-Shape Kinetic", specialAbilities: "Kinetic: Cannot move normally. Attacks in a branched range 2 tiles away. Path is blocked if a unit is adjacent.", hp: 1 },
