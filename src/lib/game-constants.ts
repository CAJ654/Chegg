...
export const MINION_MASTER_LIST: MinionData[] = [
  ...
  { type: "Phantom", cost: 3, movementPattern: "8 surrounding squares (Range 2)", attackPattern: "8 surrounding squares", specialAbilities: "Ethereal: Can only spawn, move, or attack on dark tiles.", hp: 1 },
