...
export const MINION_MASTER_LIST: MinionData[] = [
  ...
  { type: "Frog", cost: 2, movementPattern: "2 lateral, 1 diagonal", attackPattern: "None", specialAbilities: "Tongue Pull (1 Mana): Pulls a unit in a lateral line 2 squares closer.", hp: 1 },
