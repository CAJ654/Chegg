...
export const MINION_MASTER_LIST: MinionData[] = [
  ...
  { type: "Frog", cost: 2, movementPattern: "Lateral: 2, Diagonal: 1", attackPattern: "None", specialAbilities: "Tongue Pull (1 Mana): Pulls a unit in a lateral line 2 squares closer.", hp: 1 },
  ...
  { type: "Phantom", cost: 3, movementPattern: "8 directions (Range 2, Dark Tiles Only)", attackPattern: "Move-to-attack (Range 2, Dark Tiles Only)", specialAbilities: "Ethereal: Can only spawn, move, or attack on dark tiles.", hp: 1 },
  ...
  { type: "Shulker-Box", cost: 4, movementPattern: "Attack-move only", attackPattern: "T-Shape Kinetic", specialAbilities: "Kinetic: Cannot move normally. Attacks in a branched range up to 2 tiles away. Path is blocked by the first unit hit.", hp: 1 },
