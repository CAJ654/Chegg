...
export const MINION_MASTER_LIST: MinionData[] = [
  ...
  { type: "Frog", cost: 2, movementPattern: "8 directions (Range 2 lateral / 1 diagonal)", attackPattern: "None", specialAbilities: "Tongue Pull (1 Mana): Pulls a unit in a lateral line 2 squares closer.", hp: 1 },
  ...
  { type: "Phantom", cost: 3, movementPattern: "8 surrounding squares (Range 2)", attackPattern: "Move-to-attack (Range 2)", specialAbilities: "Ethereal: Can only spawn, move, or attack on dark tiles.", hp: 1 },
