...
const MINION_MASTER_LIST_DATA = [
  ...
  { "minion": "Frog", "cost": 2, "movementPattern": "8 directions (Range 2 lateral / 1 diagonal)", "attackPattern": "None", "specialAbilities": "Tongue Pull (1 Mana): Pulls a unit in a lateral line 2 squares closer." },
  ...
  { "minion": "Phantom", "cost": 3, "movementPattern": "8 surrounding squares (Range 2)", "attackPattern": "Move-to-attack (Range 2)", "specialAbilities": "Ethereal: Can only spawn, move, or attack on dark tiles." },
  ...
  { "minion": "Parrot", "cost": 5, "movementPattern": "2 lateral / 2 diagonal", "attackPattern": "Mimic", "specialAbilities": "Mimic: Copies the attack pattern of any laterally adjacent minion (friendly or enemy)." },
